          ...
          <div class="col-lg-7">
            <div class="row clock_sec clockdiv" id="clockdiv">
              ...
              <div class="col clockinner1 clockinner">
                  <h1 class="days" id="days1"></h1>
                <span class="smalltext">Days</span>
              </div>
              <div class="col clockinner clockinner1">
                  <h1 class="hours" id="hours1"></h1>
                <span class="smalltext">Hours</span>
              </div>
              <div class="col clockinner clockinner1">
                  <h1 class="minutes" id="min1"></h1>
                <span class="smalltext">Mins</span>
              </div>
              <div class="col clockinner clockinner1">
                  <h1 class="seconds" id="sec1"></h1>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            ...
            <div class="meta-text text-sm-center">
              ...
              <div class="align-items-center justify-content-center d-flex">
                <a href="https://www.facebook.com/supriyo.ghatak.33/"><i class="ti-facebook"></i></a>
                <a href="https://twitter.com/SupriyoGhatak2"><i class="ti-twitter"></i></a>
                <a href="https://www.linkedin.com/in/supriyo-ghatak-b65414172/"><i class="ti-linkedin"></i></a>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="single_event position-relative">
              <div class="event_thumb">
                  <img src="img/event/home-visual.jpg" alt=""  style="width:555px; height: 400px;"/>
              </div>
          ...
          <div class="col-lg-6 col-md-6">
            ...
            <div class="single_event position-relative">
              <div class="event_thumb">
                  <img src="img/event/img.jpg" alt="" style="width:555px; height: 400px;" />
              </div>
              <div class="event_details">
                <div class="d-flex mb-4">
                  <div class="date"><span>15</span> Jun</div>
          ...
          <div class="col-lg-12">
            <div class="text-center pt-lg-5 pt-3">
                <a href="view_details.php" class="event-link">
