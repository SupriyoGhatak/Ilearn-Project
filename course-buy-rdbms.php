...
<html lang="en">
  ...
  <body method="POST">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-6 img-responsive"><img src="img/courses/sql.jpeg" width = "100%" alt="Image" style="height: 450px;"></div>
            ...
            <div class="col-sm-5 col-lg-5"><br>
                ...
                <table>
                    <tr>
                        ...
                        <td style="color: black; font-size: 20px;"> RDBMS</td>
                    </tr>
                    <tr>
                        <th><br></th>
                    </tr>
                    <tr>
                        ...
                        <td style="color: black; font-size: 20px;"> Sanchari Acharya</td>
                    </tr>
                    <tr>
                        <th><br></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="color: black; font-size: 18px;"> 
                            ...
                            of Programming in RDBMS which will..<a href="course-details-rdbms.php">Read More</a>
                        </td>
                    </tr>
                    <tr>
                        <th><br></th>
                    ...
                    <tr>
                        ...
                        <td style="color: black; font-size: 20px;"> Rs:450</td>
                    </tr>
                    <tr>
                        <th><br></th>
                    </tr>
                ...
                <a href="payment.php?action=rdbms&price=450">  <button style="background-color: #4CAF50;
                        border: none;
                        color: white;
                        padding: 15px 32px;
                        text-align: center;
